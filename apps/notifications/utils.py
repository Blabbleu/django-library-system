...
def create_notification(subject, user, message, ical_event_details=None, type=None, receipt_info=None):
...
def send_notification_email(subject, message, recipient_list, user=None, ical_file_path=None,type=None, receipt_info=None):
    context = {
        'user': user,
        'message': message,
        'receipt_info': receipt_info,
    ...
    if type == 'return':
        email_content = render_to_string('email_templates/return_email.html', context)
    if type == 'borrow':
        email_content = render_to_string('email_templates/borrow_email.html', context)
    else:
